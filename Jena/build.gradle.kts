...
compose.resources {
    packageOfResClass = "jena.generated.resources"
...
mavenPublishing {
    ...
    coordinates("com.oriooneee.jena", "Jena", "1.0.0")
...
buildConfig {
    packageName("com.oriooneee.jena.buildconfig")
