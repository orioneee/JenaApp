package com.oriooneee.jena.engine
...
import com.oriooneee.jena.engine.rendering.FloorRenderer
import com.oriooneee.jena.engine.routing.DistanceCalculator
import com.oriooneee.jena.engine.routing.PathFinder
import com.oriooneee.jena.engine.routing.RouteBuilder
import com.oriooneee.jena.engine.utils.Log
...
class NavigationEngine(
    ...
    fun getRoute(from: ResolvedNode, to: ResolvedNode): List<NavigationDirection> {
        ...
        data class PathEvaluation(
            val steps: List<com.oriooneee.jena.domain.entities.NavigationStep>,
