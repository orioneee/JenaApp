...
1) Run `./gradlew :JetNavigation:publishToMavenLocal`
2) Open `~/.m2/repository/com/oriooneee/jet/navigation/`
...
2) Add developer id, name, email and the project url to  
   `./JetNavigation/build.gradle.kts`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :JetNavigation:publishAndReleaseToMavenCentral --no-configuration-cache`
